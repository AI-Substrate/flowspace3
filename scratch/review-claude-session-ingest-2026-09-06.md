...
## 3. Nothing fires ingest on activity — one boot/commit-time seam exists, and cannot see most seats

**Corrected 06:35Z** — the first draft said "no hook anywhere"; that was wrong in letter:
...
_Original text follows for the record:_
