...
| --- | --- | --- | --- |
| dw-0101 | gh run watch shows the gate green on a real main push; a deliberately-red probe branch run (or local act equivalent) proves it fails when tests fail | [x] checked | [bp-0001](../../backpressure.dd.md#rows) |
...
| id | assertion | state | pressure |
| --- | --- | --- | --- |
| dw-0105 | dependabot config accepted by GitHub (gh api) and first PRs/scan visible | [x] checked | [bp-0005](../../backpressure.dd.md#rows) |

### tk-0106

| id | assertion | state | pressure |
| --- | --- | --- | --- |
| dw-0106 | README section + badge live; ci-release.md follows the services convention | [x] checked | [bp-0001](../../backpressure.dd.md#rows) |
