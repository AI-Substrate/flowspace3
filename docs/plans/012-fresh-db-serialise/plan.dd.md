...
| status | shipped |
| complexity | — |
| summary | Plan 012 merged as f73dee0 after the reviewer approved delta 09509b7: every review finding is closed or explicitly accepted, and follow-up 012b closes the remaining seed-age and test-hook nits while shipping the proof artifacts. The semaphore is per process, so separate seats can still issue concurrent DDL and row 126 is REDUCED, not closed. Row 124b landed as the dedicated test postmaster; tests and probes use flowspace3-db-test on :5434. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ph-c1ee | Phase 1: lock + advice + sweep | Single unit, single coder: process-wide fs3_store create/drop serialisation, truthful failure advice, sweep coverage for canonical and legacy minted names, mutation tests, attributed DDL probes, and real-usage proof on the dedicated flowspace3-db-test postmaster at :5434; production orphan operations remain o-prime-owned. | [ ] unchecked | — | — | — | [tasks](assets/tasks/phase-1/tasks.dd.md#tasks) | — | — | — |
