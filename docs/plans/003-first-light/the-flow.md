...
**Kind**: flight-plan · **Now**: post-flight · **Intent**: plan complete; ship = the work is already on main (direct-to-main mode); archive at leisure · **Nodes**: 14 · **Events**: 30
...
flowchart TD
    ...
    planC["■° Backpressure survey<br/>■° Backpressure (re-survey: tk-0108 schema discipline)<br/>■° Backpressure (re-survey: doctor exception)<br/>■° Backpressure (re-survey: subpath dropped)"]:::chore
