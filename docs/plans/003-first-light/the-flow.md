...
**Kind**: flight-plan · **Now**: phase-1 · **Intent**: single strong worker executes the wiring; o-prime verifies via the e2e demo · **Nodes**: 13 · **Events**: 16
...
flowchart TD
    ...
    planC["■° Backpressure survey<br/>■° Backpressure (re-survey: tk-0108 schema discipline)<br/>■° Backpressure (re-survey: doctor exception)"]:::chore
