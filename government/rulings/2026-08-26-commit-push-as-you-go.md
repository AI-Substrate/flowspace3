...
6. **Conventional commits are binding** (added 2026-08-26, CI agreement): `type(scope): subject` — release-please derives versions/changelogs from them; `feat:`/`fix:` drive semver, everything else is `docs:`/`chore:`/`test:`/`refactor:`/`ci:`.
