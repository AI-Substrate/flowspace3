...
| pij-just-barnacle | plan 014 coder, RESUMED session of pij-chosen-arach (omp -c after the pij wire v2 cutover, 14:14); fs3-jobs-retention; pane %3111 | **rs** | ACTIVE — f-001/f-002/f-003 fix commit on d04ae3e |
...
| pij-sufficient-mite | plan 012b coder, RESUMED session of pij-little-junglefowl; fs3-fresh-db-serialise; pane %3113 | **rs** | DONE — PR #99 def413c CI green; merging |
